...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Crime', fields ['case_number']
        db.create_unique(u'scrape_crime_crime', ['case_number'])


    def backwards(self, orm):
        # Removing unique constraint on 'Crime', fields ['case_number']
        db.delete_unique(u'scrape_crime_crime', ['case_number'])
