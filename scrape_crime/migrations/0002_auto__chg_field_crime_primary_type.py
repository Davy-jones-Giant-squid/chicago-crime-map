...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Crime.primary_type'
        db.alter_column('scrape_crime_crime', 'primary_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    def backwards(self, orm):

        # Changing field 'Crime.primary_type'
        db.alter_column('scrape_crime_crime', 'primary_type', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
    models = {
        'scrape_crime.crime': {
            ...
            'primary_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': "''"}),
