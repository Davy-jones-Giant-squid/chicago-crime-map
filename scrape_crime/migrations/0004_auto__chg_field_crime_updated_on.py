...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Crime.updated_on'
        db.alter_column('scrape_crime_crime', 'updated_on', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    def backwards(self, orm):

        # Changing field 'Crime.updated_on'
        db.alter_column('scrape_crime_crime', 'updated_on', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))
    models = {
        'scrape_crime.crime': {
